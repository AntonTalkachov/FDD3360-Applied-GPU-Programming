...
"void hello    ()         \n"
"{                                          \n"
"    printf(\"Hello, World! Thread is %d.\\n\",(int)get_global_id(0)*8*4 +(int)get_global_id(1)*4+(int)get_global_id(2)); \n"
"    printf(\"Hello, World! My globalId is (%d,%d,%d). My groupId is (%d,%d,%d). My localId is (%d,%d,%d).\\n\", (int)get_global_id(0),(int)get_global_id(1),(int)get_global_id(2),(int)get_group_id(0),(int)get_group_id(1),(int)get_group_id(2), (int)get_local_id(0),(int)get_local_id(1),(int)get_local_id(2)); \n"
"}                                          \n";
