...
"void hello    ()         \n"
"{                                          \n"
"    printf(\"Hello, World! My globalId is (%d,%d). My groupId is (%d,%d). My localId is (%d,%d).\\n\", (int)get_global_id(0),(int)get_global_id(1),(int)get_group_id(0),(int)get_group_id(1), (int)get_local_id(0),(int)get_local_id(1)); \n"
"}                                          \n";
